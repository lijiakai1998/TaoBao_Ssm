   ...
   <script src="${pageContext.request.contextPath}/jQuery/jquery-1.12.3.js"></script>
    ...
    <script type="text/javascript">
        function del(data) {
            ...
            {
                window.location.href="${pageContext.request.contextPath}/alreadyBuy/delBuysById?id="+data;
            }
        }
...
<br>
        ...
        <form method="post" action="${pageContext.request.contextPath}/alreadyBuy/search">
    ...
    <form action="${pageContext.request.contextPath}/alreadyBuy/delBuysById" method="post" id="form">
...
<tr>
    ...
    <li>
      <c:if test="${pageInfo.isFirstPage==false}">
       <a href="${pageContext.request.contextPath}/alreadyBuy/showAllBuys?page=${pageInfo.firstPage}" style="text-decoration: none">首页</a>
      </c:if>

        <c:if test="${pageInfo.hasPreviousPage==true}">
            <a href="${pageContext.request.contextPath}/alreadyBuy/showAllBuys?page=${pageInfo.prePage}" style="text-decoration: none">上一页</a>
        </c:if>
        &nbsp;
        <c:if test="${pageInfo.hasNextPage==true}">
            <a href="${pageContext.request.contextPath}/alreadyBuy/showAllBuys?page=${pageInfo.nextPage}" style="text-decoration: none">下一页</a>
        </c:if>
        &nbsp;
        <c:if test="${pageInfo.isLastPage==false}">
            <a href="${pageContext.request.contextPath}/alreadyBuy/showAllBuys?page=${pageInfo.lastPage}" style="text-decoration: none">尾页</a>
        </c:if>
    </li>
</ul>
